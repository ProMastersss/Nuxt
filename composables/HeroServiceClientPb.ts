...
export class HeroServiceClient {
  ...
  ): Promise<hero_pb.Hero>;

  findOne(
    request: hero_pb.HeroById,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError, response: hero_pb.Hero) => void
  ): grpcWeb.ClientReadableStream<hero_pb.Hero>;
  ...
  findOne(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + "/hero.HeroService/FindOne",
        request,
        metadata || {},
